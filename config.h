static struct Config config = {
    ...
    .centerdiskradius = 0.2, /* radius of center disk */
	.separatorbeg = 0.3,  /* beginning of the separator */
	.separatorend = 0.9,  /* end of the separator */
	...
	.triangle_width = 3,
	.triangle_height = 7,
	.triangle_distance = 4  /* distance from the border of the menu */
};
